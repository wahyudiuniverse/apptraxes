...
Chart.defaults.global.legend.display = false;  
   ...
   var hrpremium_projects = new Chart(document.getElementById('hrpremium_projects').getContext("2d"), {
    type: 'bar',
    data: {
      datasets: [{
  ...
  var hrpremium_tasks = new Chart(document.getElementById('hrpremium_tasks').getContext("2d"), {
    type: 'line',
    data: {
      datasets: [{
        data: [24, 92, 77, 90, 91, 78, 28, 49, 23, 81, 15, 97, 94, 16, 99, 61,
  ...
  var hrpremium_department = new Chart(document.getElementById('hrpremium_department').getContext("2d"), {
    type: 'pie',
    data: {
  ...
  var hrpremium_designation = new Chart(document.getElementById('hrpremium_designation').getContext("2d"), {
    type: 'pie',
    data: {
  ...
  function resizeCharts() {
	hrpremium_payroll.resize();
	hrpremium_projects.resize();
    hrpremium_tasks.resize();
    hrpremium_department.resize();
    hrpremium_designation.resize();
  }
