...
class Import extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	public function index() {
		...
		if(in_array('92',$role_resources_ids) || in_array('33',$role_resources_ids)) {
			$data['subview'] = $this->load->view("admin/layout/hrpremium_import", $data, TRUE);
			...
			if(in_array($_FILES['file']['type'],$csvMimes)){
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					// $ibank_account = $this->Employees_model->bank_account_info_add($bank_account_data);
						...
						'company_id' => $line[5],
						'marital_status' => $line[6], //status perkawinan
						'gender' => $line[7], //jenis kelamin
						'date_of_birth' => $line[8],
						'date_of_joining' => $line[9],
						'contact_no' => $line[10],
						'address' => $line[11],
						'email' => $line[12],
