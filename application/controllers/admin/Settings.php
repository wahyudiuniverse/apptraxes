...
require_once('Backup_hrpremium.php');
...
class Settings extends MY_Controller {
	...
	public function constants()
	 ...
	 public function create_database_backup()
     {
		...
		if($this->input->post('type')==='backup') {
			...
			$name = 'hrpremium_backup_'.date('d-m-Y').'_'.time(); // name sql backup
			
			$newImport = new Backup_hrpremium($hostname,$database,$username,$password);
			$newImport->backup();					
	...
	public function layout_skin_info() {
		...
		if($this->input->get('type')=='hrpremium_layout_info') {
		...
		$data = array(
		'fixed_header' => $this->input->get('fixed_layout_hrpremium'),
		'boxed_wrapper' => $this->input->get('boxed_layout_hrpremium'),
		'compact_sidebar' => $this->input->get('sidebar_layout_hrpremium')
		);
