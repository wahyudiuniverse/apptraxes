...
<div class="authentication-wrapper authentication-2 px-4">
    ...
    <div class="p-4 p-sm-5"> 
        ...
        <div class="position-relative"> <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hrpremium logo"> </div>
      </div>
        <!-- / Logo -->
        ...
        <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-unlock"></i> '.$this->lang->line('xin_hr_recover_password'))); ?> </div>
    <?php echo form_close();?> 
    <!-- / Form --> 
