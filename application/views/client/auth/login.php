...
#hrload-img {
  ...
  <div class="authentication-wrapper authentication-1 px-4">
    ...
    <!-- Form -->
    <?php $ilogn_info = 'client1@hrpremium.com';?>
	<?php $ilogn_info2 = 'client2@hrpremium.com';?>
    ...
    <div class="d-flex justify-content-between align-items-center m-0">
        ...
        <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?> </div>
    <?php echo form_close(); ?> 
    <!-- / Form -->
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrpremium_vendor/hrpremium_scripts/xin_client_login.js"></script> 
<script type="text/javascript">
$(document).ready(function(){
