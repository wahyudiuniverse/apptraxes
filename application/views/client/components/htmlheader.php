...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/Ionicons/css/ionicons.min.css">
  
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/dist/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <!--<link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/select2/select2.css">-->
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/plugins/iCheck/all.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/dist/css/AdminLTE.min.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/jquery-ui/jquery-ui.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/toastr/toastr.min.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/kendo/kendo.common.min.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/kendo/kendo.default.min.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/Trumbowyg/dist/ui/trumbowyg.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/clockpicker/dist/bootstrap-clockpicker.min.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/animate.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/xin_custom.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/xin_hrpremium.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/xin_ihrpremium.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/vendor/libs/bootstrap-tagsinput/bootstrap-tagsinput.css">
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
