...
$session = $this->session->userdata('username');
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i>HO - HRD >> Approval Karyawan TKHL</h4>
  </div>
  ...
  <?php echo form_open_multipart('admin/employee_request_tkhl/update/'.$idrequest, $attributes, $hidden);?>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
        ...
        "bDestroy": true,
    "ajax": {
            url : base_url+"/request_list_tkhl/",
            type : 'GET'
        },
    dom: 'lBfrtip',
