...
if($system[0]->enable_auth_background=='yes'):
	$auth_bg = 'style="background-position: center center; background-size: cover; background-image: url('.base_url().'skin/hrpremium_assets/img/bg/bg-2.jpg");"';
else:
	$auth_bg = '';	
endif;
?>
...
<div class="login-box animated fadeInDownBig"> 
  ...
  <div class="login-box-body">
    ...
    <div class="row">
      <!-- /.col -->
      <div class="col-xs-12"> <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-unlock"></i> '.$this->lang->line('xin_hr_unlock'))); ?> </div>
      <!-- /.col --> 
    </div>
    <?php echo form_close(); ?>
    <hr>
