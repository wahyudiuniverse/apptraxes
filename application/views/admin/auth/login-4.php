...
<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/xin_login_3.css">
      ...
      <div class="row">
        <div class="col-md-7 col-lg-8 authfy-panel-right hidden-xs hidden-sm">
          <div class="hero-heading">
            <div class="headline">
              <h3><?php echo $this->lang->line('xin_hrpremium_welcome');?> <?php echo $company[0]->company_name;?></h3>
              <p><?php echo $this->lang->line('xin_hrpremium_hr_system_login_panel');?></p>
        ...
        <div class="col-xs-12 col-sm-7 col-md-5 col-lg-4 authfy-panel-left">
          ...
          <div class="brand-logo text-center">
            <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hrpremium-logo">
          </div><!-- ./brand-logo -->
          <!-- login start -->
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  <?php $attributes = array('class' => 'form-hrpremium', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard',
                    ...
                    <div class="form-group">
                      <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-lg save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?>
                    </div>
                  <?php echo form_close(); ?>
                </div>
              </div>
