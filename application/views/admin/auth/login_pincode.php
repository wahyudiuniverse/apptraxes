...
<div class="authentication-wrapper authentication-1 px-4">
    ...
    <div class="d-flex justify-content-between align-items-center m-0">
        ...
        <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="saveinfo fas fa-user-lock d-blockd"></i> '.$this->lang->line('xin_login'))); ?> </div>
    <?php echo form_close(); ?> 
    <!-- / Form -->
