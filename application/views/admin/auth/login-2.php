...
<html>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_vendor/assets/vendor/css/pages/authentication.css">
...
<!-- Preloader End -->
<div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo base_url();?>skin/hrpremium_vendor/assets/img/bg/bg-3.jpg');">
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-center align-items-center pb-2 mb-4">
            ...
            <div class="p-1"><img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hrpremium logo"></div>
          </div>
          </div>
        <!-- / Logo -->
        ...
        <div class="form-group">
			...
			if($system[0]->employee_login_id=='username'):
				...
				$ilogn_info = 'administrator@hrpremium.com';
        ...
        <div class="d-flex justify-content-between align-items-center m-0">
            ...
            <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="saveinfo fas fa-user-lock d-blockd"></i> '.$this->lang->line('xin_login'))); ?> <img id="hrload-img" src="<?php echo base_url()?>skin/img/loading.gif" style=""> </div>
        <?php echo form_close(); ?> 
        <!-- / Form --> 
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrpremium_vendor/hrpremium_scripts/xin_login.js"></script> 
<script type="text/javascript">
$(document).ready(function(){
