...
<!-- animate -->
<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/animate.css">
<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrpremium_assets/css/hrpremium/xin_login_2.css">
...
<div class="login-box animated fadeInDownBig"> 
 ...
 <div class="login-logo"> 
      ...
      <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hrpremium logo"> </div>
       <!-- /.login-logo -->
  <div class="login-box-body">    
    <p class="login-box-msg"><?php echo $this->lang->line('xin_sign_in_page_title');?></p>
    <?php $attributes = array('class' => 'form-hrpremium', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard', 'data-form-table' => 'login', 'data-is-redirect' => '1', 'autocomplete' => 'off');?>
	...
	if($system[0]->employee_login_id=='username'):
		...
		$ilogn_info = 'superadmin';
	    $ilogn_info2 = 'superadmin';
	else:
		$login_txt = $this->lang->line('xin_login_email');
		$login_title = $this->lang->line('dashboard_email');
		$ilogn_info = 'superadmin@hrpremium.com';
		$ilogn_info2 = 'employee@hrpremium.com';
	endif;?>
    ...
    <div class="row">
      ...
      <!-- /.col -->
      <div class="col-xs-12"> <?php echo form_button(array('name' => 'hrpremium_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?> </div>
      ...
      <!--div class="col-xs-8">
        <div class="btn-group">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a class="dropdown-item login-as" href="javascript:void(0);" data-username="<?php echo $ilogn_info;?>" data-password="superadmin$$##">Super Admin</a></li>
            <li><a class="dropdown-item login-as" href="javascript:void(0);" data-username="<?php echo $ilogn_info2;?>" data-password="employee$$##">Employee</a></li>
          </ul>
        </div>
      </div-->
      <!-- /.col -->
...
<!-- jQuery 3 --> 
<script src="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/jquery/dist/jquery.min.js"></script> 
<!-- Bootstrap 3.3.7 --> 
<script src="<?php echo base_url();?>skin/hrpremium_assets/theme_assets/bower_components/bootstrap/dist/js/bootstrap.min.js"></script> 

<script type="text/javascript" src="<?php echo base_url();?>skin/hrpremium_assets/vendor/jquery/jquery-3.2.1.min.js"></script> 
<script type="text/javascript" src="<?php echo base_url();?>skin/hrpremium_assets/vendor/toastr/toastr.min.js"></script> 
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrpremium_assets/hrpremium_scripts/xin_login.js"></script> 
<script type="text/javascript">
$(document).ready(function(){
