...
<div class="authentication-wrapper authentication-3">
    ...
    <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5" style="background-image: url('<?php echo base_url();?>skin/hrpremium_vendor/assets/img/bg/bg-3.jpg');">
    ...
    <div class="d-flex col-lg-4 align-items-center bg-white p-5"> 
        ...
        <div class="w-100"> 
            ...
            if($system[0]->employee_login_id=='username'):
                $login_txt = $this->lang->line('why_login_empid');
				$login_title = $this->lang->line('dashboard_empid');
