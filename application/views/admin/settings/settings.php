...
<div id="smarsdstwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/settings/');?>" data-link-data="<?php echo site_url('admin/settings/');?>" class="mb-3 nav-link hrpremium-link"><span class="sw-icon fas fa-cog"></span> <?php echo $this->lang->line('xin_system');?>
      <div class="text-muted small"><?php echo $this->lang->line('header_configuration');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('61',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/constants/');?>" data-link-data="<?php echo site_url('admin/settings/constants/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon fas fa-adjust"></span> <?php echo $this->lang->line('left_constants');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_set_up_all_types');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('93',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/modules/');?>" data-link-data="<?php echo site_url('admin/settings/modules/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon fas fa-life-ring"></span> <?php echo $this->lang->line('xin_setup_modules');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_enable_disable_modules');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('62',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/database_backup/');?>" data-link-data="<?php echo site_url('admin/settings/database_backup/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon fa fa-database"></span> <?php echo $this->lang->line('header_db_log');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_database_backup_restore');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('63',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/email_template/');?>" data-link-data="<?php echo site_url('admin/settings/email_template/');?>" class="mb-3 nav-link hrpremium-link"> <span class="sw-icon fas fa-envelope"></span> <?php echo $this->lang->line('left_email_templates');?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <label class="form-label"><?php echo $this->lang->line('xin_hrpremium_default_language');?></label>
                      <select class="form-control" name="default_language" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hrpremium_default_language');?>">
          ...
          <div class="card-body pb-2">
            <div class="card-block">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-label"> <?php echo $this->lang->line('xin_hrpremium_dashboard_options');?></label>
                    <select class="form-control" name="dashboard_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
                      ...
                      <option value="dashboard_light_2" <?php if($dashboard_option=='dashboard_light_2'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hrpremium_dashboard_2light');?></option>
                      <option value="dashboard_dark_2" <?php if($dashboard_option=='dashboard_dark_2'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hrpremium_dashboard_2dark');?></option>
                    ...
                    <br />
                    <small class="text-muted"><i class="fas fa-hand-point-up"></i> <?php echo $this->lang->line('xin_hrpremium_dashboard_options_details');?></small> </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label class="form-label" data-trigger="hover"> <?php echo $this->lang->line('xin_hrpremium_show_calendar_on_dashboard');?> </label>
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <label class="switcher switcher-success">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <select multiple="multiple" name="hr_top_menu[]" size="20" id="duallistbox-example">
                    ...
                    <option value="hr_import" <?php if(in_array('hr_import',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hr_imports').'xx';?></option>
                    <?php } ?>
                    ...
                    <option value="custom_fields" <?php if(in_array('custom_fields',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hrpremium_custom_fields');?></option>
                    <?php } ?>
