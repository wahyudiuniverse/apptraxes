...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active">
      <a href="#smartwizard-2-step-1" class="mb-4 nav-link">
    ...
    <li class="nav-item done">
      <a href="#smartwizard-2-step-2" class="mb-4 nav-link">
        <span class="sw-done-icon fas fa-user-edit"></span>
        <span class="sw-icon fas fa-user-edit"></span>
        <?php echo $this->lang->line('str_import_employees_active');?>
        <div class="text-muted small"><?php echo $this->lang->line('str_import_employees_active');?></div>
      </a>
    </li>
    <?php } ?> 
    ...
    <li class="nav-item done">
      <a href="#smartwizard-2-step-3" class="mb-4 nav-link">
    ...
    <li class="nav-item done">
      <a href="#smartwizard-2-step-4" class="mb-4 nav-link">
...
<!-- employee import standard -->
      ...
      <h6>
        <a href="<?php echo base_url();?>uploads/csv/sample-csv-employees.csv" class="btn btn-primary"> 
...
<!-- amployee active import -->
  <?php if(in_array('33',$role_resources_ids)) { ?>
    <div id="smartwizard-2-step-2" class="card animated fadeIn tab-pane step-content">
    <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('left_import_empactive').'active';?></strong> <?php echo $this->lang->line('xin_empactive_import_csv_file');?></span></div>
      <div class="card-body">
        <p class="card-text"><?php echo $this->lang->line('xin_empactive_description_line1');?></p>
        <p class="card-text"><?php echo $this->lang->line('xin_empactive_description_line2');?></p>
        <h6>
          <a href="<?php echo base_url();?>uploads/csv/sample-csv-employee-active.csv" class="btn btn-primary"> 
            <i class="fa fa-download"></i> <?php echo $this->lang->line('xin_empactive_download_sample');?> 
          </a>
        </h6>

        <?php 
        $attributes = array(
            'name' => 'import_employees_active', 
            'id' => 'import_emp_active', 
            'autocomplete' => 'off');
        ?>
        ...
        <?php echo form_open_multipart('admin/import/import_employees_active', $attributes, $hidden);?>

        <fieldset class="form-group">
          <label for="logo"><?php echo $this->lang->line('xin_empactive_upload_file');?></label>
          <input type="file" class="form-control-file" id="file" name="file">
          <small><?php echo $this->lang->line('xin_empactive_allowed_size');?></small>
        </fieldset>
        <div class="mt-1">
          <div class="form-actions box-footer">
            <button type="submit" class="btn btn-primary"> <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_empactive_import');?> </button>
          </div>
        </div>
...
<!-- attendance import -->
  <?php if(in_array('443',$role_resources_ids)) { ?>
    ...
    <?php if(in_array('444',$role_resources_ids)) { ?>
    <div id="smartwizard-2-step-4" class="card animated fadeIn tab-pane step-content">
