...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active">
      <a href="<?php echo site_url('admin/assets/');?>" data-link-data="<?php echo site_url('admin/assets/');?>" class="mb-3 nav-link hrpremium-link">
    ...
    <li class="nav-item done">
      <a href="<?php echo site_url('admin/assets/category/');?>" data-link-data="<?php echo site_url('admin/assets/category/');?>" class="mb-3 nav-link hrpremium-link">
