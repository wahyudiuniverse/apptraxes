...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active">
      <a  href="<?php echo site_url('admin/timesheet/leave/');?>" data-link-data="<?php echo site_url('admin/timesheet/leave/');?>" class="mb-3 nav-link hrpremium-link">
    ...
    <li class="nav-item clickable">
      <a  href="<?php echo site_url('admin/reports/employee_leave/');?>" data-link-data="<?php echo site_url('admin/reports/employee_leave/');?>" class="mb-3 nav-link hrpremium-link">
