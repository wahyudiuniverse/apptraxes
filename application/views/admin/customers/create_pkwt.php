                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_pkwt_no');?>" name="pkwt_no" type="text" value="0005/PKWT-JKT/SC-HR/I/2022">
                    </div>
                  </div>
                  <!-- nomor spb -->
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_spb_no');?>" name="spb_no" type="text" value="0005/SPB-JKT/SC-HR/I/2022">
                    </div>
                  </div>
                  <!-- start date -->
                  <div class="col-md-3">
