...
<?php $hidden = array('_method' => 'EDIT', '_token' => $usermobile_id, 'ext_name' => $fullname);?>
...
<div class="modal-body">
  ...
  <div class="form-group">
    ...
    <select class="form-control" name="project" id="ajx_company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_project');?>">
                        ...
                        <option value="<?php echo $contype->project_id?>" 
                            <?php if($project_id==$contype->project_id):?> selected="selected"<?php endif;?>
                        ><?php echo $contype->title?></option>
                        <?php } ?>
