...
<div class="row <?php echo $get_animate;?>">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon info-box-icon-hrpremium"><i class="fa fa-university text-green"></i></span>
      <div class="info-box-content info-box-content-hrpremium"> <span class="info-box-text"><?php echo $this->lang->line('xin_acc_account_balances');?> <span class="pull-right text-green dashboard-text"><?php echo $this->Xin_model->currency_sign(total_account_balances());?></span></span> <span class="info-box-number"><a class="text-muted" href="<?php echo site_url('admin/accounting/bank_cash');?>"> <?php echo $this->lang->line('xin_view');?> <i class="fa fa-arrow-right"></i></a></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
