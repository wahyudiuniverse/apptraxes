...
<div class="box-widget widget-user-2">
    ...
    <div class="widget-user-header">
      ...
      <h4 class="widget-user-username welcome-hrpremium-user">Welcome back, <?php echo $user[0]->first_name.' '.$user[0]->last_name;?>!</h4>
      <h5 class="widget-user-desc welcome-hrpremium-user-text">Today is <?php echo date('l, j F Y');?></h5>
    </div>
  </div>
    ...
    <div class="d-flex col-md-8 align-items-stretch">
         <?php if($system[0]->module_awards=='true'){?>
             ...
             <div class="col-md-4 col-sm-6 col-xs-12 box-footer text-black">
              <div class="clearfix">
                <span class="pull-left"><i class="fa fa-trophy text-light-blue dasboard-icon"></i> <span class="hrpremium-font-dash"><a href="<?php echo site_url('admin/awards');?>"><?php echo $this->Exin_model->total_employee_awards_dash();?> <?php echo $this->lang->line('left_awards');?></a></span></span>
              </div>
            </div>
            <?php } ?>
        <?php } else {?>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 box-footer text-black">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-calendar-check-o text-light-blue dasboard-icon"></i> <span class="hrpremium-font-dash"><a href="<?php echo site_url('admin/timesheet/attendance');?>"><?php echo $this->lang->line('xin_view');?> <?php echo $this->lang->line('dashboard_attendance');?></a></span></span>
          </div>
        </div>
        <?php } ?>
        <?php } ?>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 box-footer text-black">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-dollar text-light-blue dasboard-icon"></i> <span class="hrpremium-font-dash"><a href="<?php echo site_url('admin/expense');?>">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 box-footer">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-tags text-light-blue dasboard-icon"></i> <span class="hrpremium-font-dash"><a href="<?php echo site_url('admin/tickets');?>"><?php echo $this->lang->line('xin_view');?> <?php echo $this->lang->line('left_tickets');?></a></span></span>
          </div>
        </div>
        <?php } ?>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 box-footer text-black">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-calendar text-light-blue dasboard-icon"></i> <span class="hrpremium-font-dash"><a href="<?php echo site_url('admin/timesheet/leave');?>"><?php echo $this->lang->line('left_leave');?> <?php echo $this->lang->line('xin_performance_management');?></a></span></span>
          </div>
        </div>
        <?php } ?>
        <?php if($system[0]->module_travel=='true'){?>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 box-footer">
              <div class="clearfix">
                <span class="pull-left"><i class="fa fa-plane text-light-blue dasboard-icon"></i> <span class="hrpremium-font-dash"><a href="<?php echo site_url('admin/travel');?>"><?php echo $this->lang->line('xin_travel');?> <?php echo $this->lang->line('xin_requests');?></a></span></span>
              </div>
            </div>
            <?php } ?>
        <?php } ?>
...
<?php if(in_array('44',$role_resources_ids)) { ?>
  ...
  <div class="box">
    ...
    <div id="project-scrollbar" class="ps ps--active-y hrpremium-proj-style"> 
      <!-- Tasks -->
     ...
     foreach($aim as $dIds) {
        ...
        ?>
      <div class="card pb-4 mb-2 hrpremium-dash-prj">
