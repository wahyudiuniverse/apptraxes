...
<div class="row <?php echo $get_animate;?>">
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrpremium-4 stamp-hrpremium-md bg-hrpremium-secondary mr-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrpremium-4 stamp-hrpremium-md bg-hrpremium-success-4 mr-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrpremium-4 stamp-hrpremium-md bg-hrpremium-danger-4 mr-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrpremium-4 stamp-hrpremium-md bg-hrpremium-warning-4 mr-3">
                    <i class="fa fa-cog"></i>
                </span>
                <div>
...
<div class="col-md-12">
    <div class="card full-height">
        <div class="card-body">
            <div class="card-title"><?php echo $this->lang->line('xin_hrpremium_paid_salaries_account_balances');?></div>
            ...
            <div class="row py-3">
                ...
                <div class="col-md-3 d-flex flex-column justify-content-around">        
                        <h6 class="fw-bold text-uppercase text-warning op-8"><?php echo $this->lang->line('xin_hrpremium_travel_expenses');?></h6>
