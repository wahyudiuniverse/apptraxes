...
//$(document).ready(function(){
	...
	{ 
		id: "", class: "role-checkbox custom-control-input custom-control-input", text: "<?php echo $this->lang->line('xin_hrpremium_custom_fields');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "393",  items: [
	{ 
	...
	{ 
		id: "", class: "role-checkbox custom-control-input", 
