...
if ( ! function_exists('hrpremium_roles'))
{
	function hrpremium_roles() {
		$CI =&	get_instance();
...
if ( ! function_exists('hrpremium_office_shift'))
{
	function hrpremium_office_shift() {
		$CI =&	get_instance();
...
if ( ! function_exists('hrpremium_payroll'))
{
	function hrpremium_payroll($salary_month) {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
...
if ( ! function_exists('ihrpremium_user_payroll'))
{
	function ihrpremium_user_payroll($salary_month,$employee_id) {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
			$CI->db->where('salary_month',$salary_month);
...
if ( ! function_exists('hrpremium_payroll_this_month'))
{
	function hrpremium_payroll_this_month() {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
...
if ( ! function_exists('hrpremium_user_payroll_this_month'))
{
	function hrpremium_user_payroll_this_month($employee_id) {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
			$CI->db->where('salary_month',date('Y-m'));
			$CI->db->where('employee_id',$employee_id);
...
if ( ! function_exists('hrpremium_payroll_last_6_month'))
{
	function hrpremium_payroll_last_6_month() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 5; $i++)  {
...
if ( ! function_exists('hrpremium_user_payroll_last_6_month'))
{
	function hrpremium_user_payroll_last_6_month($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 5; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrpremium_payroll_last_1year'))
{
	function hrpremium_payroll_last_1year() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 11; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrpremium_user_payroll_last_1year'))
{
	function hrpremium_user_payroll_last_1year($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 11; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrpremium_payroll_last_2years'))
{
	function hrpremium_payroll_last_2years() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 23; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrpremium_user_payroll_last_2years'))
{
	function hrpremium_user_payroll_last_2years($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 23; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrpremium_payroll_last_3years'))
{
	function hrpremium_payroll_last_3years() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 35; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrpremium_user_payroll_last_3years'))
{
	function hrpremium_user_payroll_last_3years($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 35; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('read_invoice_record'))
{
		function read_invoice_record($id) {
			$CI =&	get_instance();
			$CI->db->from('xin_hrpremium_invoices');
...
if ( ! function_exists('last_client_invoice_info'))
{
	function last_client_invoice_info() {
		$CI =&	get_instance();
		$sql = 'SELECT * FROM xin_hrpremium_invoices order by invoice_id desc limit 1';
		$query = $CI->db->query($sql);		
		if ($query->num_rows() > 0) {
			$inv = $query->result();
			if(!is_null($inv)) {
...
if ( ! function_exists('total_last_estimates'))
{
	function total_last_estimates() {
		$CI =&	get_instance();
		$CI->db->from('xin_hrpremium_quotes');
...
if ( ! function_exists('hrpremium_team'))
{
	function hrpremium_team() {
		$CI =&	get_instance();
		$CI->db->from("xin_employees");
